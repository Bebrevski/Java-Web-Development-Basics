...
public class UserRegisterFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(request.getMethod().toLowerCase().equals("post")) {
            ...
            userRegisterBindingModel.setUsername(request.getParameter("password"));
            userRegisterBindingModel.setUsername(request.getParameter("confirmPassword"));
            userRegisterBindingModel.setUsername(request.getParameter("email"));
